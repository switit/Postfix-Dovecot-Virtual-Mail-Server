...
5. Install and configure dovecot with siev and quota plugins (in ubuntu need to install dovecot-core dovecot-imapd dovecot-pop3d dovecot-lmtpd mangge-sieve dovecot-managesieved)
```
